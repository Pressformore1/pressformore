...
class WallFlagConfirmation
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="P4M\ModerationBundle\Entity\WallFlag",inversedBy="confirmations")
     */
    private $flag;
    /**
     * @ORM\ManyToOne(targetEntity="P4M\ModerationBundle\Entity\WallFlagArchive",inversedBy="confirmations",cascade="persist")
     */
    private $flagArchive;
     ...
     * @return WallFlagConfirmation
     */
    public function setFlag(\P4M\ModerationBundle\Entity\WallFlag $flag = null)
    {
        $this->flag = $flag;
     ...
     * @return WallFlagConfirmation
     */
    public function setFlagArchive(\P4M\ModerationBundle\Entity\WallFlagArchive $flagArchive = null)
    {
