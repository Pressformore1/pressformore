...
class AuthenticationHelper {
    ...
    /**
     * Constructor
     * @param \P4M\MangoPayBundle\MangoPaySDK\MangoPayApi Root/parent instance that holds the OAuth token and Configuration instance
     */
     ...
     * @return string
     * @throws \P4M\MangoPayBundle\MangoPaySDK\Exception If MangoPay_ClientId or MangoPay_ClientPassword is not defined
     */
     ...
     * @throws \P4M\MangoPayBundle\MangoPaySDK\Exception If required constants are not defined.
     */
     ...
     * 
     * @return string Value for HTTP header with authentication string
     * @throws \P4M\MangoPayBundle\MangoPaySDK\Exception If OAuth token is not created (or is invalid) for strong authentication.
     */
