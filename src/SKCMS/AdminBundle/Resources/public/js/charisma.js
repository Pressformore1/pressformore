...
//	$("input:checkbox, input:radio, input:file").not('[data-no-uniform="true"],#uniform-is-ajax').uniform();
	...
	//flot chart
        ...
        $('.flotchart').each(function(){
            var htmlData = JSON.parse($(this).attr('data-flotData'));
            var values = $.map(htmlData, function(value, index) {
                return [value];
            });
            var data = {
...
//            
//            $.plot($(this), [
//			{ label: "sin(x)",  data: JSON.parse($(this).attr('data-flotData'))}
//			
//		], {
//			series: {
//				lines: { show: true },
...
//			},
//			xaxis: {
//				ticks: [Object.keys(JSON.parse($(this).attr('data-flotData')))]
//			},
////			yaxis: {
////				ticks: 10,
////				min: -2,
...
function modals()
{
    $('.btn-setting').click(function(e){
		e.preventDefault();
		$('#myModal .modal-header h3').text($(this).data('title'));
